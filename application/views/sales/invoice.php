...
<div id="header"><?php echo $this->lang->line('sales_invoice'); ?></div>
	<div id="block2">
		<div > 
			...
			?> 
				...
				<textarea id="customer" rows="5" cols="40" style="font-weight:bold;overflow:visible;float:right">CONSIGNEE:&#13;&#10;<?php echo $customer_info ?></textarea>
			<?php
			}
			?>
		</div> 
	...
	<div id="block2">
		<textarea id="company-title" rows="5" cols="35" style="font-weight:bold;"><?php echo $company_info ?></textarea>
		<table id="meta">
			<tr>
			...
			<tr>
				<td class="meta-head"><?php echo "E-way bill no."; ?></td>
				<td><textarea rows="5" cols="6"></textarea></td>
			</tr>
		</table>
	</div>
	...
	<table id="items">
		...
		foreach($cart as $line=>$item)
		{
			...
			?>
				<tr class="item-row">
					...
					<td contentEditable="true"><?php echo to_currency($item['price']); ?></textarea></td>
					<td style='text-align:center;' ><textarea rows="4" cols="6"><?php echo $item['discount'] . '%'; ?></textarea>
					</td>
					<?php if($discount > 0): ?>
						<td style='text-align:center;' contentEditable="true"><?php echo to_currency($item['discounted_total'] / $item['quantity']); ?>
						</td>
					<?php endif; ?>
					<td style='border-right: solid 1px; text-align:right;' contentEditable="true"><?php echo to_currency($item['discounted_total']); ?>
					</td>
				</tr>
				<?php
		...
		<tr>
			...
			<td class="total-line"><textarea rows="5" cols="6"><?php echo $this->lang->line('sales_sub_total'); ?></textarea></td>
			<td  colspan="2" class="total-value" contentEditable="true"><?php echo to_currency($subtotal); ?></td>
		</tr>
		...
		?>
			<tr>
				...
				<td class="total-line"><textarea rows="5" cols="6"><?php echo $sales_tax['tax_group']; ?></textarea></td>
				<td   colspan="2" class="total-value" contentEditable="true"><?php echo to_currency_tax($sales_tax['sale_tax_amount']); ?></td>
			</tr>
		<?php
		}
		?>
		...
		<tr>
			<td colspan="<?php echo $invoice_columns-3; ?>" class="blank"> </td>
			<td  class="total-line"><textarea rows="5" cols="6"><?php echo $this->lang->line('sales_total'); ?></textarea></td>
			<td colspan="2" class="total-value" contentEditable="true"><?php echo to_currency($total); ?></td>
		</tr>
   ...
   <div id="terms">
   <textarea rows="2" cols="6" style="font-weight:bold;">Total Amount(in words):<?php
